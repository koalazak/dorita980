...
var dorita980 = function localV2 (user, password, host, emitIntervalTime) {
  ...
  return Object.assign(client, {
    ...
    getWeek: () => waitPreferences(false, ['cleanSchedule2'], true),
    getPreferences: (decode) => waitPreferences(decode, ['cleanMissionStatus', 'cleanSchedule2', 'name', 'vacHigh', 'signal'], false),
    ...
    setWeek: (args) => _apiCall('delta', {'cleanSchedule2': args}),
