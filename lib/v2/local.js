...
var dorita980 = function localV2 (user, password, host, emitIntervalTime) {
  ...
  function _apiCall (topic, command, additionalArgs) {
    return new Promise((resolve, reject) => {
      ...
      const stringCommand = JSON.stringify(cmd);
      console.log(`JSON Command is ${stringCommand}`);
      client.publish(topic, stringCommand, function (e) {
  ...
  return Object.assign(client, {
    ...
    start: (args) => _apiCall('cmd', 'start', args),
